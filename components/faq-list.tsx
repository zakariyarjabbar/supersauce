...
export const faqs = [
  ...
  },
  {
    ...
    a: "الأصناف والمكونات والأسعار من منيو المطعم. صور المنتجات محسّنة بالذكاء الاصطناعي اعتماداً على صور المنيو، وقد يختلف التقديم الفعلي. تأكد من السعر والتوفر مع الفرع عند الطلب.",
    category: "المنيو",
  },
  {
